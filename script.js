...
const SERVERS = [
    {
        ...
        buildUrl: function(id, type, s, e, ts) {
            ...
            if (type === 'tv') {
                return 'https://vidlink.pro/embed/tv/' + id + '/' + s + '/' + e + '?primaryColor=e50914&autoplay=true' + startTimeParam;
            }
            return 'https://vidlink.pro/embed/movie/' + id + '?primaryColor=e50914&autoplay=true' + startTimeParam;
        }
    },
    {
        name: 'SERVER 2',
